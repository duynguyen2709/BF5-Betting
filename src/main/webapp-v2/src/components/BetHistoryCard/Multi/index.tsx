        ...
        return (
          <React.Fragment key={bet.betId}>
            ...
            {bet.result === BET_RESULT.Unfinished.result ? (
              <BetHistoryDetailRow left='Tiền Lời:' right={`${bet.potentialProfit.toLocaleString()}đ`} />
            ) : null}
            ...
            {bet.result === BET_RESULT.Win.result || bet.result === BET_RESULT.HalfWin.result ? (
              <BetHistoryDetailRow left='Tiền Lời:' right={`${bet.actualProfit!.toLocaleString()}đ`} />
            ) : null}
            {bet.result === BET_RESULT.Lost.result || bet.result === BET_RESULT.HalfLost.result ? (
              <BetHistoryDetailRow left='Tiền Lỗ:' right={`${bet.actualProfit!.toLocaleString()}đ`} />
            ) : null}
