...
import {
  useInsertBatchBetHistoryMutation,
  useInsertBetHistoryMutation,
} from '@/hooks/useBetHistoryQuery';
...
export const AddBetHistoryModal: React.FC<AddBetHistoryModalProps> = ({
  data,
  isOpen,
  onUpdateSuccess,
  onClose,
  ...
  const tablePagination = isBatchMode
    ? { showTotal: (total: number) => `Tổng: ${total} cược` }
    : false;
