...
export const HistoryCardMetadata: React.FC<HistoryCardMetadataProps> = ({ players, data, style }) => {
  ...
  return (
    <Meta
      ...
      title={title}
      description={<div style={{ fontWeight: 400, fontSize: 14 }}>{parseDateDescription(startDate, endDate)}</div>}
      style={style}
    />
  )
}
