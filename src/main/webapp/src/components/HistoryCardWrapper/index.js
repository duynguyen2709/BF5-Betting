...
const HistoryCardWrapper = ({data, historyFilterParams, historyActiveTab, onChangeHistoryActiveTab, cardRef}) => {
    ...
    return <Card ref={cardRef} className={"card-bet-wrapper"}>
        <HistoryCardMetadata players={players} data={historyFilterParams} style={{padding: '0.5rem', paddingTop: '1rem'}}/>
