...
public class DateTimeUtil {
  ...
  private static final SimpleDateFormat FRIENDLY_DATE_TIME_FORMATTER = new SimpleDateFormat(
      READABLE_DATE_TIME_FORMAT);
  private static final SimpleDateFormat SYSTEM_DATE_ONLY_FORMATTER = new SimpleDateFormat(
      SYSTEM_DATE_ONLY_FORMAT);
